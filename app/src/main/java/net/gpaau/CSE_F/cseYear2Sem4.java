...
public class cseYear2Sem4 extends AppCompatActivity {
	//Variable Declaration
	Spinner cs3452, cs3491, cs3492, cs3401, cs3451, ge3451, ncc, cs3461, cs3481;
	Button calculate;
	@Override
	protected void onCreate(Bundle savedInstance){
		super.onCreate(savedInstance);
		setContentView(R.layout.activity_cse_year2_sem4);
		//Variable Mapping
		cs3452 = findViewById(R.id.spinner);
		cs3491 = findViewById(R.id.spinner7);
		cs3492 = findViewById(R.id.spinner6);
		cs3401 = findViewById(R.id.spinner5);
		cs3451 = findViewById(R.id.spinner4);
		ge3451 = findViewById(R.id.spinner3);
		ncc = findViewById(R.id.spinner2);
		cs3461 = findViewById(R.id.spinner1);
		cs3481 = findViewById(R.id.spinner8);
		...
		String st_cs3401 = cs3401.getSelectedItem().toString();
		...
		double gpa = gap.GPA_even(st_cs3452,st_cs3491,st_cs3492,st_cs3401,st_cs3451,st_ge3451,st_cs3461,st_cs3481,st_ncc);
